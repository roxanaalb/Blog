...
function onHtmlLoaded() {
    var btnAdd= $('#add-article');
     ...
     window.location.href= "https://roxana-roxanaalb.c9users.io/Blog-TemaFinala/templates/7.createarticle.html";        
            });
         ...
         articles.getAll(searchValue,"").done(listArticles) ;
          ...
          for (var i=0; i<articles.models.length; i++) {
           ...
           textContainer.addClass("preview");
            ...
            var editBtn = $("<button id=" + articles.models[i].id +">"+ "</button>").html("Edit");
            articleBox.append(editBtn);
            editBtn.on("click", function(){
            var idArticle= $(this).attr("id");
        window.location.href = "https://roxana-roxanaalb.c9users.io/Blog-TemaFinala/templates/8.editarticle.html?id=" + idArticle;        
            });
